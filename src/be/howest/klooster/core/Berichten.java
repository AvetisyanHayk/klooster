...
public final class Berichten {
    ...
    public static final String NEUTRAAL = "neutraal";
    public static final String GOED = "goed";
    public static final String ABSOLUUT_GOED = "absoluut goed";
    public static final String RECHTMATIG = "rechtmatig";
    public static final String CHAOTISCH = "chaotisch";
